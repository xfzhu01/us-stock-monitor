...
public class OpenAiClient implements AiClient {
    ...
    public OpenAiClient(AiProperties props, ObjectMapper objectMapper, WebClient.Builder webClientBuilder) {
        this.config = props.getOpenai();
    ...
    public ChatResult chatWithMeta(String systemPrompt, String userPrompt) {
        if (config.getApiKey() == null || config.getApiKey().isBlank()) {
            log.warn("OpenAI API key not configured; skipping chat call");
